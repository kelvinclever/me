...
const MenuItem = ({ href, label, menuOpen, onClick }) => {
  return (
    <a
      href={href}
      onClick={onClick}
      className={`
        relative text-2xl font-semibold text-white my-3 py-2 px-6
...
export const MobileMenu = ({ menuOpen, setMenuOpen }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`
        absolute bottom-8 text-white/60 text-sm
